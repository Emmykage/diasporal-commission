  ...
  return (
    <nav className='flex items-center top-0 left-0 fixed w-full z-10 justify-between px-10 bg-red-20 text-white'>
        ...
        <ul className='flex font-medium text-white  basis-1/2'>
            <li className='px-4 py-2 cursor-pointer'><NavLink to="/"> Home </NavLink></li>
            ...
            <li  className='px-4 py-2 cursor-pointer'><NavLink to={'/contact-us'} href=""> Contact Us </NavLink></li>
        </ul>
